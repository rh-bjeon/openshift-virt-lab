...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Node</td>
            <td>쿠버네티스 스케줄러에서 확인하고 사용, 클러스터에서 사용 가능한 리소스를 나타내는 개체</td>
        </tr>
        <tr>
            <td>Machine</td>
            <td>인프라 제공자가 관리하는 개체, 실습에서 오픈시프트 가상화를 사용할 때, Metal3 오퍼레이터에 의해 추상화되는 물리적 서버,MachineSet 패러다임을 통해 세트로 그룹화되고 관리 </td>
        </tr>
        <tr>
            <td>BareMetalHost</td>
